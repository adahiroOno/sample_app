...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/x86_64-darwin17.7.0")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/sadahiro/rails_projects/sample_app/~/.rbenv/versions/1.9.3-p551")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/sadahiro/rails_projects/sample_app/~/.rbenv/versions/1.9.3-p551' '--with-openssl-dir=/usr/local/opt/openssl' '--with-libyaml-dir=/usr/local/opt/libyaml' '--with-readline-dir=/usr/local/opt/readline' 'CC=clang' 'LDFLAGS=-L/Users/sadahiro/rails_projects/sample_app/~/.rbenv/versions/1.9.3-p551/lib ' 'CPPFLAGS=-I/Users/sadahiro/rails_projects/sample_app/~/.rbenv/versions/1.9.3-p551/include '"
  CONFIG["vendordir"] = "$(rubylibprefix)/vendor_ruby"
  CONFIG["sitedir"] = "$(rubylibprefix)/site_ruby"
  CONFIG["ruby_version"] = "1.9.1"
  CONFIG["sitearch"] = "$(arch)"
  CONFIG["arch"] = "x86_64-darwin17.7.0"
  ...
  CONFIG["cppflags"] = "-I/Users/sadahiro/rails_projects/sample_app/~/.rbenv/versions/1.9.3-p551/include "
  CONFIG["NULLCMD"] = ":"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/sadahiro/rails_projects/sample_app/~/.rbenv/versions/1.9.3-p551/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/sadahiro/rails_projects/sample_app/~/.rbenv/versions/1.9.3-p551/lib  -L/usr/local/lib"
  CONFIG["CFLAGS"] = "$(cflags)  -pipe"
  CONFIG["CC"] = "clang"
  CONFIG["target_os"] = "darwin17.7.0"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "x86_64"
  CONFIG["target"] = "x86_64-apple-darwin17.7.0"
